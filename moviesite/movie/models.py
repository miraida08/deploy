...
class Director(models.Model):
    ...
    age = models.PositiveSmallIntegerField(default=0, null=True, blank=True)
    director_image = models.ImageField(upload_to='director_img/', verbose_name='Image', null=True, blank=True)
...
class Actor(models.Model):
    ...
    actor_image = models.ImageField(upload_to='actor_img/', verbose_name='Image', null=True, blank=True)
...
class Movie(models.Model):
    ...
    status_movie = models.CharField(max_length=10, choices=STATUS, default='simple')
...
class MovieLanguages(models.Model):
    ...
    video = models.FileField(upload_to='movie_language/', verbose_name='Video', null=True, blank=True)
    movie = models.ForeignKey(Movie, related_name='movie', on_delete=models.CASCADE)


class Moments(models.Model):
    movie = models.ForeignKey(Movie, related_name='movie_moments', on_delete=models.CASCADE)
    movie_moments = models.ImageField(upload_to='moments_movie/', verbose_name='epizods', null=True, blank=True)
